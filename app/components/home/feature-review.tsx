...
const englishFeaturedTestimonials = [
  ...
  },
  {
    ...
    imageAlt:
      "Im Yubin, Lee Gyuri, and Coach Junhyun Jeon at the HYROX Champions photo wall",
    featured: true,
    quotes: [
      {
...
const FeatureReviewSection = () => {
  ...
  const reviews =
    locale === "en" ? englishFeaturedTestimonials : featuredTestimonials;
  ...
  return (
    <section
      className="editorial-section featured-section"
      id="featured-review"
    >
      <div className="featured-inner">
        <div className="section-index">
          <span>03 / THE PEOPLE, THE PROGRESS</span>
          <span>REAL WORK. REAL STORIES.</span>
        </div>
                ...
                return (
                  <div key={testimonial.id} className="px-0.5">
                    <div className="featured-grid">
                      ...
                      <div className="featured-quote min-w-0">
                        ...
                        <div className="review-body mt-5 space-y-5">
                          {quoteBlocks}
                        </div>
                      </div>
                    </div>
          ...
          {reviews.length > 1 && (
            <div className="review-navigation">
              <button
                ...
                onClick={handlePrev}
                aria-label={
                  locale === "en" ? "Previous review" : "이전 피쳐 리뷰 보기"
                }
              >
                <ArrowLeft size={17} />
              </button>
              ...
              <button
                ...
                onClick={handleNext}
                aria-label={
                  locale === "en" ? "Next review" : "다음 피쳐 리뷰 보기"
                }
              >
                <ArrowRight size={17} />
              </button>
